    ...
    Claim(
        ...
        (
            ...
            Requirement(
                ...
                "Makefile exposes the per-screen GUI visual regression re-baseline harness",
            ),
            Requirement(
            ...
            Requirement(
                "docs/reference/ai-review.md",
                "tests/baseline/gui/00-real-trust-gate.png",
                "AI review surface documents the trust-gate GUI screenshot artifact path",
            ),
            Requirement(
                "docs/reference/ai-review.md",
                "tests/baseline/gui/02-real-vault-list.png",
                "AI review surface documents the vault-list GUI screenshot artifact path",
            ),
            Requirement(
                "docs/reference/ai-review.md",
                "tests/baseline/gui/07-real-locked.png",
                "AI review surface documents the locked-screen GUI screenshot artifact path",
            ),
            Requirement(
                ".github/agents/paranoid-security-auditor.md",
                "inspect the per-screen screenshot artifacts (real and decoy passes)",
                "AI security assessor requires per-screen screenshot inspection for UI-sensitive changes",
            ),
            Requirement(
                ".github/instructions/security-assurance.instructions.md",
                "plus inspection of the captured per-screen",
                "path-scoped instructions require per-screen screenshot inspection for UI-sensitive changes",
            ),
        ),
    ),
)
