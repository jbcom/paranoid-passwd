...
* **release:** publish basename-only checksum manifests for release assets

## [3.6.3](https://github.com/jbcom/paranoid-passwd/compare/paranoid-passwd-v3.6.2...paranoid-passwd-v3.6.3) (2026-05-05)


### Bug Fixes

* **release:** build Darwin amd64 artifacts on the current Intel macOS runner

## [3.6.2](https://github.com/jbcom/paranoid-passwd/compare/paranoid-passwd-v3.6.1...paranoid-passwd-v3.6.2) (2026-05-05)


### Bug Fixes

* **release:** keep vendored Cargo sources byte-stable on Windows checkouts

## [3.6.1](https://github.com/jbcom/paranoid-passwd/compare/paranoid-passwd-v3.6.0...paranoid-passwd-v3.6.1) (2026-05-05)


### Bug Fixes

* **release:** publish artifacts from the active Cargo target directory and sync workspace versions
...
* **release:** open PR against jbcom/pkgs instead of direct push ([#71](https://github.com/jbcom/paranoid-passwd/issues/71)) ([ca025c1](https://github.com/jbcom/paranoid-passwd/commit/ca025c169bdf37d50763c1b6d2f56a35052230c9))
* **release:** run publish-packages + smoke-test on workflow_dispatch ([#68](https://github.com/jbcom/paranoid-passwd/issues/68)) ([ecf6602](https://github.com/jbcom/paranoid-passwd/commit/ecf660283fb133ee1ecac54adce6a6fcb7d79b52))
...
* add end-to-end install smoke test to CLI release pipeline ([#47](https://github.com/jbcom/paranoid-passwd/issues/47)) ([7e316e4](https://github.com/jbcom/paranoid-passwd/commit/7e316e4b071336578531f3caaeaad76dbca11ca9)), closes [#45](https://github.com/jbcom/paranoid-passwd/issues/45)
